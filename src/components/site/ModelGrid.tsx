...
export function ModelVideoCard({ model }: { model: CloudinaryModel }) {
  const [loaded, setLoaded] = useState(false);
  return (
    <figure className="group relative overflow-hidden bg-cacao/5 border border-primary/10 aspect-[3/4]">
