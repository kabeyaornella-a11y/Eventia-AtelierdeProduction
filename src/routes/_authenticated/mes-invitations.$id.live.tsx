...
import { ArrowLeft, BedDouble, Bus, Lock, QrCode, Trash2, Plus, Check, Camera } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <section>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="font-display text-2xl">Galerie — modération</h2>
              </div>
              <p className="text-sm italic text-muted-foreground mb-4">
                Validez les photos envoyées par vos invités avant qu'elles n'apparaissent sur
                l'invitation et la page Live.
              </p>
              <GalleryModeration invitationId={id} />
            </section>
