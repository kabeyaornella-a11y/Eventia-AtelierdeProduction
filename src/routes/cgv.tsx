  ...
  return (
    <main className="min-h-screen bg-background py-16 px-6">
      <article className="max-w-3xl mx-auto prose prose-stone">
        ...
        <p>
          Les présentes CGV régissent la vente d'invitations et expériences signature Eventia entre
          l'atelier et le client.
        </p>
        <h2 className="font-serif text-2xl mt-8">Commande</h2>
        <p>
          Toute commande passée via le configurateur emporte acceptation des présentes CGV. Un
          acompte ou paiement total est exigé à la commande.
        </p>
        <h2 className="font-serif text-2xl mt-8">Délais</h2>
        <p>
          Production : 2 à 4 semaines après validation de la maquette. Délais indicatifs, non
          contractuels en cas de personnalisation lourde.
        </p>
        <h2 className="font-serif text-2xl mt-8">Rétractation</h2>
        <p>
          Les invitations étant personnalisées, le droit de rétractation ne s'applique pas (art.
          L221-28 du Code de la consommation).
        </p>
        <h2 className="font-serif text-2xl mt-8">Litiges</h2>
        <p>
          Droit français applicable. Médiation préalable obligatoire avant toute saisine du tribunal
          compétent.
        </p>
      </article>
    </main>
